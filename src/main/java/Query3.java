    ...
    public static void main(String[] args) {
         ...
         */
            ...
            for (int i = 1; i <= temp4.keys().collect().size(); i++) {
                Integer finalI1 = i;
                List<Tuple2<Integer, Tuple2<Double, String>>> tmplist = LloydKMeans.Naive((temp4.
                        filter(x -> x._1().equals(finalI1)).values()), finalI1, NUMERO_TOP_TREND, MAX_ITERATION_LLOYDKMEANS);
